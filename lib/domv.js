 ...
 * @param {?(external:Node|external:Node[])} node
 ...
 */
module.exports.wrap = function(node, ComponentConstructor, a0, a1, a2, a3, a4, a5, a6, a7, a8, a9)
{
        var ret;
        var i;
 ...
 */
module.exports.create = function(document, nodeName, className)
{
        var node;
        var wrapped;
        var skipArguments = 2;
 ...
 */
module.exports.shorthand = function(document, tagName)
{
        var fn = domv.create;
        var thisObj = this;
        var shorthandArguments = slice.call(arguments, 2);
        ...
        if (arguments.length === 2 &&
            document.__domv__shorthandCache &&
            document.__domv__shorthandCache[tagName])
        {
                return document.__domv__shorthandCache[tagName];
        }

        shorthandInstance = function(a0, a1, a2, a3, a4)
        {
        ...
        if (arguments.length === 2)
        {
                if (!document.__domv__shorthandCache)
                {
                        document.__domv__shorthandCache = Object.create(null);
                }

                document.__domv__shorthandCache[tagName] = shorthandInstance;
        }
 ...
 * // <div>Hi!</div>
 */
module.exports.text = function(document, text, t2, t3, t4, t5)
{
        if (document.isDOMVComponent)
        {
                document = document.document;
        ...
        switch (arguments.length)
        {
                ...
                case 6:
                        ...
                        break;
                default:
                        text = slice.call(arguments, 1).join(' ');
        }
...
module.exports.cssStringEscape = function(str, wrapInQuotes)
{
        ...
        if (wrapInQuotes || wrapInQuotes === undefined)
        {
                return '"' + str + '"';
        }
