 ...
 *      <p>Otherwise the argument is parsed using {@link module:domv/lib/Component#parseShorthandArgument}</p>
 * @param {...(string|external:Node|module:domv/lib/Component|Object.<string, string>)} content
 *      Parsed using {@link module:domv/lib/Component#parseShorthandArgument}
 *
...
module.exports.create = function(document_, nodeName, className)
{
        ...
        {
                wrapped.parseShorthandArgument(arguments[i]);
        }
