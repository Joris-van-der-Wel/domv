...
* [domv](#module_domv)
  * _static_
    * [.NodeType](#module_domv.NodeType) : <code>number</code>
...
### domv.NodeType : <code>number</code>
All of the valid node types in DOM (excluding the ones that are deprecated).

**Scope**: static enum property of <code>[domv](#module_domv)</code>  
**Properties**
...
**Scope**: static constant of <code>[domv](#module_domv)</code>  
...
**Scope**: static method of <code>[domv](#module_domv)</code>  
**Throws**:
...
**Scope**: inner typedef of <code>[domv](#module_domv)</code>  
...
**Scope**: inner external of <code>[domv](#module_domv)</code>  
**See**
...
**Scope**: instance method of <code>[Document](#external_Document)</code>  
**See**
...
* [domv/lib/Component](#module_domv/lib/Component)
  * [Component](#exp_module_domv/lib/Component--Component) ⏏
    ...
    * [.emit(name, [data], [bubbles], [cancelable])](#module_domv/lib/Component--Component#emit) ⇒ <code>boolean</code>
...
**Scope**: instance constant of <code>[Component](#exp_module_domv/lib/Component--Component)</code>  
...
#### component.emit(name, [data], [bubbles], [cancelable]) ⇒ <code>boolean</code>
...
| [bubbles] | <code>boolean</code> | <code>true</code> |  |
| [cancelable] | <code>boolean</code> | <code>true</code> |  |
...
**Scope**: instance property of <code>[HtmlDocument](#exp_module_domv/lib/HtmlDocument--HtmlDocument)</code>  
...
**Scope**: instance method of <code>[HtmlDocument](#exp_module_domv/lib/HtmlDocument--HtmlDocument)</code>  
